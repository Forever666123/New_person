...
| 台账 | 学习／排班／项目／英语／作息／交易六类，只记他主动说出口的。追问的时机按事情本身的周期走，问过两次没下文就不再问 |
| 第一次上线先说一句 | 不然第一天是你发消息进去，等三小时才有回音——功能全对，看起来像坏了 |
| 停机期间的消息补回来 | Discord 不补发新会话之前的事件，部署那几分钟他说的话本来会永远消失。补回来的按**消息本身的时间**算冷热，不会被当成刚说的秒回过去 |
